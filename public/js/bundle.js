...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var url, res, _err$response$data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/users/changePassword' : 'http://127.0.0.1:8000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: url,
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', (_err$response$data = _context.t0.response.data) === null || _err$response$data === void 0 ? void 0 : _err$response$data.message);
        case 11:
        case "end":
          return _context.stop();
      }
